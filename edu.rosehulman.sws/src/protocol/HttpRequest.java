...
public class HttpRequest {
	...
	private void parseURI(){
		strings=uri.substring(1).split("/", 3);
	}
	public String getContextRoot(){
		...
		return strings[0];
//		int i=uri.substring(1).indexOf("/");
//		
//		if (i==-1){
//			System.out.println("Context: "+uri.substring(1));
//			return uri.substring(1);
//		}
//
//		System.out.println("Context: "+uri.substring(1, i+1));
		//return uri.substring(1, i+1);
	}
