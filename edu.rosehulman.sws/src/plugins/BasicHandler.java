 ...
 * Chandan-- change me! 
 */
public class BasicHandler extends Plugin{
	...
	public BasicHandler(String rootDirectory) {
		super(rootDirectory, BasicHandler.class.getName());
	...
	public void registerSelf(Map<String, Plugin> map) {
		map.put(BasicHandler.class.getName(), this);
//		for (Servlet s: servlets){
